  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <?php
        ...
        <div class="mb-3">
          <label for="address2">'.$fila['Field'].' <span class="text-muted">(Optional)</span></label>';
                /////////////////////////////
              $resultado2 = mysqli_query ($enlace,"
            SELECT ".$fila['Field']." AS columna FROM ".$_GET['tabla']." WHERE Identificador = ".$_GET['id']." ");
